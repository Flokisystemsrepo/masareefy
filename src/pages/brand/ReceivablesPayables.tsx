...
const getItemType = (item: any): "receivable" | "payable" => {
  // Check if the item has receivable-specific fields or is from receivables list
  return item.amount > 0 && item.entityName ? "receivable" : "payable";
};
...
const ReceivablesPayablesPage: React.FC = () => {
  ...
  const handleDelete = (id: string, type: "receivable" | "payable") => {
    if (window.confirm(t("receivablesPayables.messages.deleteConfirm"))) {
      if (type === "receivable") {
  ...
  // Helper function to determine if an item is a receivable or payable
  const getItemType = (
    item: Receivable | Payable
  ): "receivable" | "payable" => {
    return receivablesList.some((r) => r.id === item.id)
      ? "receivable"
      : "payable";
  };

  return (
    <FeatureLock featureName="Receivables & Payables">
      <div
          ...
          {showFilters && (
            <CardContent className="space-y-4">
              ...
              <div className="relative">
                ...
                <Input
                  placeholder={t(
                    "receivablesPayables.filters.searchPlaceholder"
                  )}
                  value={searchTerm}
                ...
                <div>
                  ...
                  <Select value={statusFilter} onValueChange={setStatusFilter}>
                    <SelectTrigger>
                      <SelectValue
                        placeholder={t(
                          "receivablesPayables.filters.allStatuses"
                        )}
                      />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">
                    {activeTab === "all"
                      ...
                      : t(
                          "receivablesPayables.emptyState.noPayablesDescription"
                        )}
                  </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder={t(
                        "receivablesPayables.form.namePlaceholder"
                      )}
                      required
                    />
                  </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder={t(
                      "receivablesPayables.form.receiptPlaceholder"
                    )}
                  />
                </div>
